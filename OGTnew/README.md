...
### If `https://yoursite.com/OGTnew/` shows this README instead of the app

Your host is serving **`README.md`** (or a Markdown page) as the default page, and **`index.html` is not** what gets loaded for `/OGTnew/`.
...
After that, visiting `/OGTnew/` should load the Cert Checker UI, not this text.
