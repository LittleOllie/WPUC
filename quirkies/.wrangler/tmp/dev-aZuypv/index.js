    ...
    if (path === "/api/wallet") {
      try {
        ...
        const quirkies = quirkiesCol.idKeys.map(
          (id) => rowFromCol(quirkiesCol, id)
        );
        const quirklings = quirklingsCol.idKeys.map(
          (id) => rowFromCol(quirklingsCol, id)
        );
...
// .wrangler/tmp/bundle-AibIG4/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-AibIG4/middleware-loader.entry.ts
