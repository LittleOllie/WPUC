...
export function WalletPassportSquare({ data, prefs, placedStamps, siteUrl }: Props) {
  const accent = accentForPersonality(data.personalityId);

  return (
    <div
      className="wdna-dna-card wdna-dna-card--square"
    ...
    >
      ...
      <WalletPassportIdentity data={data} prefs={prefs} layout="inline" />
